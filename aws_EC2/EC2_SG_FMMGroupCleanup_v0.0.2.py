...
def remove_security_groups_from_nic(network_interface_info, security_group_ids: List[str]) -> tuple[bool, List[str]]:
    """
...
for account in account_list:
    ...
    for nic in nic_list:
        ...
        # print(f"NIC SGs: {nic_sg_list}")
        status,removed_sg = remove_security_groups_from_nic(nic,sg_final_dict.keys())
        if status:
